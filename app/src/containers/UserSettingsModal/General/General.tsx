    ...
    <Fragment>
      ...
      <OptionGroup>
        <div>
          ...
          <Description>
            These are used to notify you when a task is due and when a friend updates a shared list.
          </Description>
        </div>
        <Toggle
          onChange={(e, bool) => {
      ...
      <OptionGroup>
        <div>
          ...
          <Description>
            BetterDo leverages your system preferences to turn dark mode on or off. However, turn this setting off to
            fully disable dark mode on this device.
          </Description>
        </div>
        <Toggle
          onChange={(e, bool) => {
      ...
      <OptionGroup>
        <div>
          ...
          <Description>This will determine what timezone to use when setting due dates on tasks.</Description>
        </div>
        <Dropdown
      ...
      <OptionGroup>
        <div>
          <Label>Logout</Label>
          <Description>Clear your current session and return to login screen.</Description>
        </div>
